;; Test variadic functions in SuperVM modes
;; Should work with both superast (SuperDirectVM) and superstackast (SuperStackVM)
...
;; Define a function that counts arguments
(define count-args (lambda args
